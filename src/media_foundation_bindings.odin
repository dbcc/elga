...
MF2DBuffer_LockFlags_Read :: u32(1)
MF2DBuffer_LockFlags_Write :: u32(2)
...
IID_IMF2DBuffer2 := &win32.GUID{0x33ae5ea6, 0x4316, 0x436f, {0x8d, 0xdd, 0xd7, 0x3d, 0x22, 0xf8, 0x29, 0xec}}
...
MF_DEVSOURCE_ATTRIBUTE_SOURCE_TYPE_VIDCAP_SYMBOLIC_LINK := win32.GUID{0x58f0aad8, 0x22bf, 0x4f8a, {0xbb, 0x3d, 0xd2, 0xc4, 0x97, 0x8c, 0x6e, 0x2f}}
...
IMF2DBuffer2 :: struct #raw_union {
	#subtype unknown: win32.IUnknown,
	using vtable: ^IMF2DBuffer2_VTable,
}
IMF2DBuffer2_VTable :: struct {
	using unknown_vtable: win32.IUnknown_VTable,
	Lock2D: rawptr,
	Unlock2D: proc "system" (this: ^IMF2DBuffer2) -> win32.HRESULT,
	GetScanline0AndPitch: rawptr,
	IsContiguousFormat: rawptr,
	GetContiguousLength: rawptr,
	ContiguousCopyTo: rawptr,
	ContiguousCopyFrom: rawptr,
	Lock2DSize: proc "system" (this: ^IMF2DBuffer2, flags: u32, scanline: ^^u8, pitch: ^i32, buffer_start: ^^u8, length: ^u32) -> win32.HRESULT,
	Copy2DTo: rawptr,
}
